          ...
          <div className="space-y-8 text-left">
            ...
            <div className="pt-6 border-t border-deep-purple/50">
              <button
                ...
                className="w-full btn-magic py-4 rounded-lg flex items-center justify-center gap-2 text-lg mb-6 hover:animate-pulse-glow disabled:opacity-50 disabled:cursor-not-allowed disabled:shadow-none disabled:hover:animate-none"
              >
