          ...
          <div className="space-y-8 text-left">
            <div>
              ...
              <input
                ...
                className="w-full glass-input text-white rounded-t-lg px-4 py-3 focus:outline-none focus-visible:ring-2 focus-visible:ring-gold"
            ...
            <div className="pt-6 border-t border-deep-purple/50">
              <button
                ...
                className="w-full btn-magic py-4 rounded-lg flex items-center justify-center gap-2 text-lg mb-6 hover:animate-pulse-glow disabled:opacity-50 disabled:cursor-not-allowed focus-visible:ring-2 focus-visible:ring-gold"
              >
              ...
              <div className="mt-6 flex flex-col gap-3">
                <input
                  ...
                  className="w-full glass-input text-white rounded-t-lg px-4 py-3 text-center uppercase tracking-widest focus:outline-none focus-visible:ring-2 focus-visible:ring-gold"
                ...
                <button
                  ...
                  className="w-full btn-ghost py-3 rounded-lg flex items-center justify-center gap-2 font-medium disabled:opacity-50 disabled:cursor-not-allowed focus-visible:ring-2 focus-visible:ring-gold"
                >
