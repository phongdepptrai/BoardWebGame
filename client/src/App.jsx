          ...
          <div className="space-y-8 text-left">
            ...
            <div className="pt-6 border-t border-deep-purple/50">
              <button
                ...
                className="w-full btn-magic py-4 rounded-lg flex items-center justify-center gap-2 text-lg mb-6 hover:animate-pulse-glow disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:shadow-none disabled:hover:translate-y-0"
              >
              ...
              <div className="mt-6 flex flex-col gap-3">
                <label htmlFor="joinRoomId" className="sr-only">Room Code</label>
                <input
                  id="joinRoomId"
                  type="text"
                  value={joinRoomId}
                ...
                <button
                  ...
                  className="w-full btn-ghost py-3 rounded-lg flex items-center justify-center gap-2 font-medium disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:bg-transparent disabled:hover:shadow-none"
                >
